...
a release (third-party marketplaces do not auto-update: `claude plugin
marketplace update` first). The shell scripts need only bash and jq;
`audit.py` needs the uv environment (see the skill's "Cold start").
